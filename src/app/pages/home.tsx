...
export default function HomeSection () {
    ...
    return (
        <section id="home" data-section="home">
            <div className="relative h-screen text-gray-500" id="animation" ref={animationRef} />
            ...
            <div className="absolute left-0 top-[25%] flex  flex-col space-y-4 pl-4 text-center sm:bottom-[25%] sm:text-left md:bottom-[25%] md:left-[8%] md:text-left lg:bottom-[35%] lg:left-[15%] lg:text-left xl:bottom-[45%]">
                ...
                <h2 className="pt-4 text-2xl font-medium text-cyan-600 sm:pl-4 lg:pl-3">Software Engineer &amp; Tech Lead from  🇦🇷</h2>
                <div className="flex justify-self-stretch sm:w-full sm:p-4 md:w-[70%] lg:w-[40%] lg:pl-3">
                    <p className="text-lg text-lavender">
                            Passionate about continuous learning and building impactful solutions. <span className='text-cyan-600'>Open Source enthusiast</span>{' '}
                            committed to contributing to the community with a <span className='text-cyan-600'>results-driven, minimalist mindset</span>.
                    </p>
                </div>
                <div className="flex flex-col justify-center space-y-2 px-4 text-white sm:flex-row sm:justify-start sm:space-x-4 sm:space-y-0">
                    ...
                    <LinkButton href='mailto:elias.leguizamon1997@gmail.com' name='Email'>
                        <Mail width='20' height='20' color="#141414" />
                    </LinkButton>
                </div>
            </div>
