...
export function Chat () {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        sendQuestion(form.get('question') as string).then((response) => {
            ...
            <form onSubmit={handleSubmit} className="w-full">
                <div className='relative mt-4 flex'>
                    ...
                    <input
                        ...
                        name="question"
                        autoFocus
                        className='block h-12 w-[95%] rounded-md rounded-r-none  border border-gray-800 bg-gray-950 px-4 py-2 text-gray-300 focus:outline-none md:px-12'
                        placeholder='Ask me ...'
                    />
