...
export default function TimelineItem (props: props) {
    return (  
        <li className="ml-4 pb-8">
            <span className="absolute -start-3 flex h-6 w-6 items-center justify-center rounded-full bg-gunmetal-blue ring-8 ring-white dark:ring-gray-800">
                <svg className="h-2.5 w-2.5 text-white dark:text-blue-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
