...
export default function Card(props: props) {
    return (
        ...
        >
            <div className="absolute z-50 hidden flex-col group-hover:flex group-hover:opacity-100">
            ...
            <img src={props.image} width={400} alt={props.title} height={700} className="size-full rounded-xl object-cover transition-opacity duration-300 group-hover:brightness-50" />
        </div>
    )
}